...
clearBtn.addEventListener('click', DeleteRect);
...
function SaveCanvasImage() {
	...
	console.log('saved', savedImageData);
	// let d = (document.createElement('img').src = savedImageData);
